...
/**
 * A node with neighbor nodes that could be placed in the north, east, south and
 * west positions.
 * 
...
public class Node {
	...
	/**
	 * The neighbor nodes for this node. These exits in the four wind
	 * directions. Are initialized to null.
	 */
	...
	/**
	 * Sets the node of a given location index. 0 north, 1 east, 2 south, 3 west
	 * 
	 * @param n
	 *            The node to set as a neighbor.
	 * @param i
	 *            The index of the location to do so.
	 */
	...
	/**
	 * Returns a neighbor node by index. The indexes are defined as: 0 north, 1
	 * east, 2 south, 3 west Neighbor can be null.
	 * 
	 * @param i
	 ...
	 * 
	 * @param d
	 *            The direction of the neighbor node.
	...
	/**
	 * Returns an array of four neighbor nodes. Beware that neighbor nodes can
	 * be null.
	 * 
	...
	public boolean equals(Node other) {
		...
		if (other.getBlock().equals(this.getBlock()) && other.getPosition().equals(this.getPosition())) {
			result = true;
		}
		return result;
	}
